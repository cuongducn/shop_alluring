    ...
    <table class="table table-bordered">
        ...
        <tr dir-paginate = "sp in cban |filter: search| itemsPerPage: pageSize" current-page="currentPage">
            <td>@{{$index+1+(currentPage-1)*pageSize}}</td>
                ...
                <td><button class="btn btn-info" ng-click="editClick(sp.id_bill_ban)"><i class="fa fa-edit"></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(sp.id_bill_ban)"><i class="fa fa-trash"></button></td>
                <td><button class="btn btn-danger" ng-click=""><i class="fa fa-eye"></button></td>
