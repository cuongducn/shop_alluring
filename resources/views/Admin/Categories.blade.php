    ...
    <table class="table table-bordered" >
        ...
        <tr dir-paginate = "sp in lsp |filter: search| itemsPerPage: pageSize" current-page="currentPage">
            <td>@{{$index+1+(currentPage-1)*pageSize}}</td>
                <!-- <td>@{{ sp.id }}</td> -->
                <td>@{{ sp.tenloai }}</td>
                <td><img src="/images/products/product/@{{sp.anh}}" class="img-categories" alt=""></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" ng-model="lsps.id">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" class="form-control" id="file" ng-model="lsps.anh">
                            </div>
                        </div>
                        <div class="form-group row">
